...
$service = Kit::GetParam('service', _REQUEST, _WORD, '');
...
{
    syslog(LOG_INFO, 'switching service'.$service);
    ...
    switch ($service)
    {
	    ...
	    syslog(LOG_INFO, "created XMDSJsonRpc");
